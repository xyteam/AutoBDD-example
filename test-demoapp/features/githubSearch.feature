...
Scenario: search for webdriverio repository
    ...
    Then  I expect that element "[placeholder='Search GitHub']" contains the value "webdriverio selenium"
    When  I click on the element "button=Search"
    Then  I expect that element ".repo-list-item:first-child" contains the text "webdriverio"
    And   I expect that element ".repo-list-item:first-child" contains the text "selenium"
