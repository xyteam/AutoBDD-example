...
Feature: Test select elements
    ...
    Scenario: Test if we can select the second option of a select element
        ...
        Then I expect that the element "#selectElementTest option:nth-child(2)" is selected

    Scenario: Test if we can select the third option of a select element
        Then I expect that the element "#selectElementTest option:nth-child(3)" is not selected
        When I select the 2nd option for element "#selectElementTest"
        Then I expect that the element "#selectElementTest option:nth-child(3)" is selected

    Scenario: Test if we can select the fourth option of a select element
        Then I expect that the element "#selectElementTest option:nth-child(4)" is not selected
        When I select the 3th option for element "#selectElementTest"
        Then I expect that the element "#selectElementTest option:nth-child(4)" is selected

    Scenario: Test if we can select the first option of a select element
        When I select the 1st option for element "#selectElementTest"
        Then I expect that the element "#selectElementTest option:nth-child(1)" is not selected
        When I select the 0th option for element "#selectElementTest"
        Then I expect that the element "#selectElementTest option:nth-child(1)" is selected
