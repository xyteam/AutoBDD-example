...
Feature: File download and validation
  ...
  Scenario: Open url, check content, download file and check downloaded content - PDF file
    ...
    Then  I expect that the downloaded file "pdf-test.pdf" does contain exactly 18 lines
    And   I expect that the downloaded file "pdf-test.pdf" does contain more than 10 lines
    And   I expect that the downloaded file "pdf-test.pdf" does contain less than 20 lines
    And   I expect that the downloaded file "pdf-test.pdf" at line 4 does contain the text "PDF Test File"
    And   I expect that the downloaded file "pdf-test.pdf" not does contain the text "PDF Tast File"
  ...
  Scenario: Download and check file - XLS file
    ...
    Then  I expect that the downloaded file "file_example_XLS_10.xls" does contain 10 rows
    And   I expect that the downloaded file "file_example_XLS_10.xls" does contain 10 rows and 8 columns
